...
public final class PoCMecanumDrive {
    ...
    public PoCMecanumDrive(DcMotorEx leftFront, DcMotorEx leftBack, DcMotorEx rightBack,
                           DcMotorEx rightFront, IMU imu, VoltageSensor voltageSensor, Pose2d pose) {
        this.pose = pose;
